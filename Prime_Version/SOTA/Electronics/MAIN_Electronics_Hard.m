...
algorithms = {
    ...
    'SFO',          @SFO,          'Swift Flight Optimizer';
    'StMA',         @StMA,         'Sterna Migration Algorithm';
    'CAO',          @CAO,          'Cell Autophagy Optimization';
    'ERBMO',        @ERBMO,        'Enhanced Red-billed Blue Magpie Optimizer';
    'SMNBKA_ICMIC', @SMNBKA_ICMIC, 'Binary Evolution Black-kite Algorithm';
};
num_algorithms = size(algorithms, 1);num_algorithms = size(algorithms, 1);
