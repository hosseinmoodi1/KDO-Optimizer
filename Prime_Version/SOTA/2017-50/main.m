...
algorithms = {
    ...
    'CAO',          'Cell Autophagy Optimization';
    'ERBMO',        'Enhanced Red-billed Blue Magpie Optimizer';
    'SMNBKA_ICMIC', 'Binary Evolution Black-kite Algorithm';
};
